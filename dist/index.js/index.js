...
const reportWebVitals = onPerfEntry => {
  if (onPerfEntry && onPerfEntry instanceof Function) {
    Promise.resolve().then(function () { return require('./web-vitals-eecfcc3f.js'); }).then(_ref => {
      let {
        getCLS,
        getFID,
        getFCP,
...
root.render( /*#__PURE__*/React__namespace.createElement(React__namespace.StrictMode, null, /*#__PURE__*/React__namespace.createElement(App, null)));
